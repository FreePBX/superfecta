...
/*** Original script by Nerd Vittles. (Google for Caller Id Trifecta)
	6/21/2011 Major Overhaul, now using classes for everything. Might eliminate need for FreePBX in the future actually (95% sure on this)
...
abstract class superfecta_base {
