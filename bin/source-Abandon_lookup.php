...
//  Collect info
	$source_desc = "Artificially sets the CNAM to a user defined value so that no further lookups will be performed.  This can be useful to prevent a lookup from progressing to the next scheme, or to alway keep post-processing within the same scheme.  Lookup sources that come after this source within the same scheme will be ignored.";
