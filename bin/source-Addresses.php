...
$source_desc = "http://phonenumbers.addresses.com - This will return only residential listings, business listings will not be returned.<br><br>This data source requires Superfecta Module version 2.2.1 or higher.";
...
if($usage_mode == 'get caller id')
{
	...
	else
	{
		...
		if($start>1)
		{
			...
			$end = ($end > strpos($value,"&nbsp;<img")) ? strpos($value,"&nbsp;<img") : $end;
