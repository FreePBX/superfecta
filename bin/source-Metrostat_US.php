...
// Contributed by PBXIAF forum member Krycek 11/5/2009 v1.0.0

//configuration / display parameters
//The description cannot contain "a" tags, but can contain limited HTML. Some HTML (like the a tags) will break the UI.
$source_desc = "http://my.metrostat.net - US CNAM Provider. This source is fee based and requires registration.";
...
if($usage_mode == 'get caller id')
{
	...
	if(!$number_error)
	{
		...
		$npalistUS = array(
			...
			"229", "231", "234", "239", "240", "242", "246", "248", "249", "251", "252",
			...
			"340", "343", "345", "347", "351", "352", "360", "361", "365", "386", "401", "402",
			...
			"575", "579", "580", "585", "586", "600", "601", "602", "603", "605", "606",
			...
			"868", "869", "870", "873", "876", "878", "900", "901", "903", "904", "906",
	...
	if($number_error)
	{
		if($debug)
		{
			print "Skipping Source - Toll Free or Non NAPA: ".$thenumber."<br>\n";
		}
	}
	else
	{
		$url = "http://cnam1.edicentral.net/getcnam?q=C&f=S&dn=".$thenumber;
