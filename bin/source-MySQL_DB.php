...
$source_param['Post_Process_SQL_Query']['desc'] = 'Substitute "[CNAM]" (including sqare brackets all uppercase) to use the Caller Name string.  Substitute "[SOURCE]" to use the winning source.  Substitute "[NUMBER"] for the CID';
...
if($usage_mode == 'get caller id')
{
	...
	if (strlen($wquery_string) == 0) exit; // abandon search if no sql query is passed
...
//	swap out [SPAM], [CNAM], [SOURCE], [NUMBER]
