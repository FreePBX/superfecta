...
if( class_exists("Net_Growl") ){
	...
	if($debug){
		print '<span style="color:red"><b>ERROR:</b> Send_To_Growl require the Net_Growl pear module !!!!<br>';
		print '	To install it, please run "pear install Net_Growl" from the command line.</span><br><br>';
	}
}
