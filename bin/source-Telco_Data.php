...
if($usage_mode == 'get caller id')
{
	...
	if(!$number_error)
	{
		...
		$npalistCAN = array(
			"204", "226", "250", "289", "306", "403", "416", "418", "438",
			"450", "506", "514", "519", "581", "587", "604", "613", "647",
			"705", "709", "778", "780", "807", "819", "867", "902", "905",
 			"800", "866", "877", "888" 
		);

		if(in_array($npa, $npalistUS) || in_array($npa, $npalistCAN))
		{
			$validnpa = true;
		}
	}
	...
	if($number_error)
	{
		if($debug)
		{
			print "Skipping Source - Toll Free or Non US number: ".$thenumber."<br>\n";
		}
	}
	else
	{
		...
		//$start2 = strpos($value, "<company>");
		//$result3 = substr($value,$start2+9);
